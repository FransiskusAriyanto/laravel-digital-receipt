...
<div class="row">
    ...
    <?php echo csrf_field(); ?>
        <div class="col-12">
          <input type="text" class="form-control <?php $__errorArgs = ['hasil'];
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ta\resources\views/main/validasibyscan.blade.php ENDPATH**/ ?>